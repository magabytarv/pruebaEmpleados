<?php
    ...
    if ($this->session->userdata('logged') == 1){
        ...
        $UID = $user_login['UID'];
        if($tipo_cargo == 1) {
            redirect('servicios/reporte_contratos'."?ID=".$_GET['ID']."&IDB=".$_GET['IDB']."#/", 'refresh');
        } elseif($tipo_cargo == 2) {
            redirect('servicios/registrar_contrato'."?ID=".$_GET['ID']."&IDB=".$_GET['IDB']."#/", 'refresh');
        } else {
            $datasession = array(
                'loggedIn' => '',
                'logged' => '',
...
<html lang="es-EC">
  <head>
    ...
    <link rel="stylesheet" href="<?=$template_url?>src/assets/intranet/css/bootstrap.css">
    <link rel="stylesheet" href="<?=$template_url?>src/assets/intranet/css/font-awesome.css">
    <link rel="stylesheet" href="<?=$template_url?>src/assets/intranet/css/login.css">
    <link href="<?=$template_url?>src/assets/intranet/css/animate.min.css" rel="stylesheet"/>
    <link rel="stylesheet" href="<?= $template_url ?>src/assets/css/sweetalert2.css" />
    ...
    <script src="<?= $template_url ?>bower_components/bootstrap/js/bootstrap-tooltip.js "></script>
    <script src="<?= $template_url ?>bower_components/bootstrap/js/bootstrap-dropdown.js "></script>
    <script src="<?= $template_url ?>bower_components/bootstrap/js/bootstrap-tab.js "></script>
